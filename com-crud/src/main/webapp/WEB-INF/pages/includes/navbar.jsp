<nav class="navbar navbar-expand-lg navbar-light bg-light" style="padding:6px 16px 6px 16px;">
	<a class="navbar-brand" href="homePage"><img alt="" src="resources/static/images/spring_logo.png"></a>
		...
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item dropdown"><a
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					<a class="nav-link dropdown-item" href="reportsPage">Reports</a>
